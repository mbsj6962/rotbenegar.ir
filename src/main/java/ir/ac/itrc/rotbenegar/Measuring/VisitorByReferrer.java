...
public class VisitorByReferrer extends VisitorByCriterion {

	public VisitorByReferrer() {
		super(CriterionType.REFERRER);
	}
	...
	protected Dataset<Row> prepareData(Dataset<Row> records) {
            if (ArrayUtils.contains(records.columns(), Measures.DataFieldsName.ref.name()) && 
