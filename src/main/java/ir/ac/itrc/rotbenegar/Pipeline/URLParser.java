...
public class URLParser implements java.io.Serializable {
    ...
    private Broadcast<Map<String, String>> ip2DomainMap;
    ...
    public Broadcast<Map<String, String>> loadip2DomainMap(String filename) {
    ...
    private BufferedReader readFileFromResources(String filename) throws IOException {
    ...
    public String extractTLD(String host) throws Exception {
        try {
//            java.net.URL url = new java.net.URL(URLDecoder.decode(host,"UTF-8"));
            String domain = HostExtract.getHost(host);
            return domain;
        } catch (Exception e) {
    ...
    public boolean validIP(String host) {
        if (host == null) {
            return false;
        }
        try {
    ...
    public boolean validIpPort(String host) {
        if (host == null) {
            return false;
        }
        if (host.contains(":")) {
    ...
    public String getHost(String urlString) throws Exception {
